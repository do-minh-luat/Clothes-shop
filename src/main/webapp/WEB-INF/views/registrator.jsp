...
<body>
	...
	<form action="/registrator" method="POST"
		style="width: 60%; margin: auto; border-radius: 10px; padding: 10px; display: flex; flex-direction: column;">
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">User name</label> <input type="text" class="form-control"
				id="exampleInputEmail1" aria-describedby="emailHelp" name="username" required style="box-shadow: 0 0 1px">
		</div>
		<div class="mb-3">
			<label for="exampleInputPassword1" class="form-label">Password</label>
			<input type="password" class="form-control"
				id="exampleInputPassword1" name="password" required style="box-shadow: 0 0 1px">
		</div>
		<div class="mb-3">
			<label for="e" class="form-label">Email</label>
			<input type="Email" class="form-control"
				id="e" name="email" required style="box-shadow: 0 0 1px">
		</div>
		<div class="mb-3">
			<label for="a" class="form-label">Full name</label>
			<input type="text" class="form-control"
				id="a" name="fullname" required style="box-shadow: 0 0 1px">
		</div>
