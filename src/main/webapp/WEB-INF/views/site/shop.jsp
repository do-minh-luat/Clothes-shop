			...
			<div class="col-lg-3 col-md-12">
				...
				<div class="border-bottom mb-4 pb-4">
					...
					<form action="/shop/price" method="post">
						...
						<div
							class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
							<input type="checkbox" class="custom-control-input" name="min=100,max=200" id="price-1"><button>t</button>
						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center mb-3">
								<li class="page-item "><a class="page-link"
									href="/shop?p=${page.number-1}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
