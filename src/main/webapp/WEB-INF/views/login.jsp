				...
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav ml-auto py-0">
							<a href="" class="nav-item nav-link">Login</a> <a href="/registrator"
	...
	<form action="/login" method="POST"
		...
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">User name</label> <input type="text" class="form-control"
				id="exampleInputEmail1" aria-describedby="emailHelp" name="username" style="box-shadow: 0 0 1px">
		</div>
		<div class="mb-3">
			<label for="exampleInputPassword1" class="form-label">Password</label>
			<input type="password" class="form-control"
				id="exampleInputPassword1" name="password" style="box-shadow: 0 0 1px">
		</div>
		<button type="submit" class="btn btn-primary">Submit</button>
		<a href="/forget">Forget your email?</a>
	</form>
	<!-- Vendor End -->
