...
<body>
			...
			<c:forEach var="item" items="${cs }">
				<div class="col-lg-4 col-md-6 pb-1">
					<div class="cat-item d-flex flex-column border mb-4"
						style="padding: 30px;">
						<p class="text-right">${item.products.size()}Products</p>
						<a href="/shop/0?category=${item.id }"
							class="cat-img position-relative overflow-hidden mb-3"> <img
							class="img-fluid" src="/img/${item.id}.png" alt=""
	...
	<div class="container-fluid pt-5">
		...
		<div class="row px-xl-5 pb-3">
			<c:forEach var="item" items="${ps }">
				<div class="col-lg-3 col-md-6 col-sm-12 pb-1">
					<div class="card product-item border-0 mb-4">
						<div
							class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
							<img class="img-fluid w-100" src="/img/${item.id}.jpg"
								alt="" style="max-height: 259px; object-fit: cover;">
						</div>
						<div
						...
						<div
							...
							<a href="/detail/${item.id }" class="btn btn-sm text-dark p-0"><i
								...
								href="/cart/add/${item.id}?quantity=1&url="
